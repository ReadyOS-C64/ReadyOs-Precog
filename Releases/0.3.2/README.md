...
- Public release line: `0.3.2`
- Current artifact build in this tree: `0.3.2J`
...
The current public `0.3.2` release is still comparatively generic
...
The current public release line is `0.3.2`. Full-content ReadyOS
...
ReadyOS `0.3.2` is still explicitly experimental, but the purpose
