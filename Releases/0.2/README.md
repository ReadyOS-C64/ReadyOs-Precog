...
The current public `0.2` release is still comparatively generic
...
The current public release line is `0.2`. Full-content ReadyOS
...
ReadyOS `0.2` is still explicitly experimental, but the purpose
