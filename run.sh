...
PREBOOT_PRG="$BIN_DIR/preboot.prg"
TEST_PRG="$BIN_DIR/test_reu.prg"
LAUNCHER_PRG="$BIN_DIR/launcher.prg"
EDITOR_PRG="$BIN_DIR/editor.prg"
CALCPLUS_PRG="$BIN_DIR/calcplus.prg"
HEXVIEW_PRG="$BIN_DIR/hexview.prg"
GAME2048_PRG="$BIN_DIR/game2048.prg"
DEMINER_PRG="$BIN_DIR/deminer.prg"
SIDETRIS_PRG="$BIN_DIR/sidetris.prg"
CAL26_PRG="$BIN_DIR/cal26.prg"
DIZZY_PRG="$BIN_DIR/dizzy.prg"
README_PRG="$BIN_DIR/readme.prg"
SHOWCFG_PRG="$BIN_DIR/showcfg.prg"
...
show_help() {
    ...
    echo "  hexview        Run $HEXVIEW_PRG directly"
    echo "  2048           Run $GAME2048_PRG directly"
    echo "  sidetris       Run $SIDETRIS_PRG directly"
    echo "  deminer        Run $DEMINER_PRG directly"
    echo "  cal26          Run $CAL26_PRG directly"
    echo "  dizzy          Run $DIZZY_PRG directly"
    echo "  readme         Run $README_PRG directly"
