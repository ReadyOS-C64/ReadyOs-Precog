...
LIB_LAUNCHER = $(TUI_BASE_MENU_MISC) $(REU_DMA_SRC) $(RESUME_STATE_SRC)
...
LIB_EDITOR = $(TUI_BASE_MENU_INPUT_NAV_MISC) $(LIB_REU_DMA) $(LIB_CLIP_COPY_PASTE_COUNT) $(RESUME_STATE_SRC) $(STORAGE_DEVICE_SRC)
LIB_CALCPLUS = $(TUI_BASE_NAV) $(LIB_REU_DMA) $(LIB_CLIP_COPY_PASTE_COUNT) $(RESUME_STATE_SRC)
...
LIB_README = $(TUI_BASE_NAV_MISC) $(REU_DMA_SRC) $(RESUME_STATE_SRC)
...
$(CAL26): $(APPS_DIR)/cal26/cal26.c $(LIB_CAL26)
	$(CC) $(APP_CFLAGS) -m $(OBJ_DIR)/cal26.map -o $@ $^
